...
export const translations = {
  bn: {
    ...
    "island_lang_title": "ভাষা পরিবর্তন (Language):",
    "island_vibe_title": "আবহাওয়া পরিবর্তন (Atmosphere Vibe):",
    "vibe_dawn": "ভোর",
    "vibe_morning": "সকাল",
    ...
    "location_maps_btn": "গুগল ম্যাপে লাইভ রুট ও দিকনির্দেশনা দেখুন (Open Google Maps)",
    ...
    "tab_mahalaya": "মহালয়া ও স্তোত্র (MAHALAYA)",
    "tab_chandi_songs": "চণ্ডীপাঠ ও গান (SONGS)",
    "tab_dhak_beats": "ঢাকের বোল (DHAK)",
  ...
  en: {
    ...
    "island_lang_title": "Change Language / ভাষা পরিবর্তন:",
    "island_vibe_title": "Atmosphere Vibe / আবহাওয়া পরিবর্তন:",
    "vibe_dawn": "Dawn",
    ...
    "tab_mahalaya": "Mahalaya Broadcast (MAHALAYA)",
    "tab_chandi_songs": "Chandi Path Songs (SONGS)",
    "tab_dhak_beats": "Heritage Dhak Bols (DHAK)",
